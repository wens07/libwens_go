...
func BuildTransferTransaction(refinfo, wif string, from, to, memo string, amount, fee int64,
...
func BuildWithdrawCrosschainTransaction(refinfo, wif, addr string, fee int64,
	crosschain_addr, crosschain_symbol, crosschain_amount, chain_id string) (b []byte, err error) {
